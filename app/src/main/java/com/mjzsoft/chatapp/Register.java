...
import com.mjzsoft.chatapp.databinding.ActivityRegisterBinding;
...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.registerButton.setOnClickListener(v -> {
            ...
            user = binding.username.getText().toString().toUpperCase();
            ...
            if (user.equals("")) {
                ...
                StringRequest request = new StringRequest(Request.Method.GET, url, response -> {
                    Firebase reference = new Firebase("https://mahdi-chat-app-default-rtdb.firebaseio.com/users");
